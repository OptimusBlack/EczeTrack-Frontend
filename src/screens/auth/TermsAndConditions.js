  ...
  return (
    <WhiteBackground>
      ...
      <ScrollView>
        ...
        <Text style={styles.heading}>USER GENERATED CONTRIBUTIONS</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.heading}>CONTRIBUTION LICENSE</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.heading}>GUIDELINES FOR REVIEWS</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.heading}>MOBILE APPLICATION LICENSE</Text>
        <Text style={styles.paragraph}>
          <Text style={{fontWeight: 'bold'}}>Use License</Text>{'\n\n'}
          ...
          {'\n\n'}
          <Text style={{fontWeight: 'bold'}}>Apple and Android Devices</Text>{'\n\n'}
        ...
        <Text style={styles.heading}>THIRD-PARTY WEBSITES AND CONTENT</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.heading}>APP MANAGEMENT</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
            We care about data privacy and security. Please review our personal data collection agreement. By using the Application, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Application is hosted in the United States. If you access the Application from the European Union, the United States, or any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Hong Kong, then through your continued use of the Application or Services, you are transferring your data to Hong Kong, and you expressly consent to have your data transferred to and processed in Hong Kong. Further, we do not knowingly accept, request, or solicit information from children or knowingly market to children.

        </Text>
        <Text style={styles.heading}>COPYRIGHT INFRINGEMENTS</Text>
        <Text style={styles.paragraph}>
            We respect the intellectual property rights of others. If you believe that any material available on or through the Application infringes upon any copyright you own or control, please immediately notify us using the contact information provided below (a “Notification”). A copy of your Notification will be sent to the person who posted or stored the material addressed in the Notification. Please be advised that pursuant to government law you may be held liable for damages if you make material misrepresentations in a Notification. Thus, if you are not sure that material located on or linked to by the Application infringes your copyright, you should consider first contacting an attorney.
        </Text>
        <Text style={styles.heading}>TERM AND TERMINATION</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.heading}>MODIFICATIONS AND INTERRUPTIONS</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
            These Terms of Use and your use of the Application are governed by and construed in accordance with the HK government law applicable to agreements made and to be entirely performed within the HK government law, without regard to its conflict of law principles.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          {'\n\n'}
            If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the courts, and the Parties hereby consent to, and waive all defenses of lack of, personal jurisdiction, and forum non convenient with respect to venue and jurisdiction in such state and federal courts.
        </Text>
        ...
        <Text style={styles.heading}>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          {'\n\n'}
            WeDerm Limited{'\n'}
            1/F, Knowles Building, The University of Hong Kong, Hong Kong{'\n'}
            ml.wederm@gmail.com{'\n'}
        </Text>
      </ScrollView>
